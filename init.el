;; .emacs.d/init.el
;; Initially based on https://realpython.com/emacs-the-best-python-editor/
...
;; ====================================
;;
;; Enable aspell for spell checking. Note the commented out line is only
;; required in Windows.
...
(custom-set-variables
 ...
 '(package-selected-packages (quote (elpy material-theme better-defaults markdown-mode))))
(custom-set-faces
